    ...
    faqs: [
      {
        ...
        answer:
          'The maximum civil penalty is £30,000 per offence under the Housing and Planning Act 2016. Councils can issue this as an alternative to prosecution, and there is no limit on the magistrates\' court fine for the criminal offence of operating an unlicensed HMO.',
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          'The maximum civil penalty is £30,000 per offence for Housing Act 2004 offences, £7,000 for first PRS Database registration offences, and £40,000 for repeat registration offences under the Renters\' Rights Act 2025.',
      },
      {
  ...
  // ─── COMPLIANCE (6) ────────────────────────────────────────────────
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'HMO licences include mandatory conditions on room sizes and maximum occupancy. A breach of these conditions is an offence that can result in a civil penalty of up to £30,000 or prosecution. The council must also consider whether to revoke the licence if overcrowding is persistent.',
      },
    ],
    relatedSlugs: [],
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Both carry a maximum civil penalty of £30,000. In practice, penalties for breach of conditions are often lower than for unlicensed operation, reflecting the lower culpability. Councils should follow their published penalty matrix, considering severity, harm, and landlord track record.',
      },
    ],
    relatedSlugs: [],
  },
    ...
    faqs: [
      {
        ...
        answer:
          'If the agent is the person having control of or managing the property, they can be liable for the offence of operating without a licence. Civil penalties of up to £30,000 apply. Whether the agent is liable depends on the specific facts and the management agreement.',
      },
      {
