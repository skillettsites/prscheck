    ...
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-navy-400">
              Everything your housing team needs to identify, investigate, and enforce
              against non-compliant PRS properties.
            </p>
          </div>
          <div className="mt-10 grid grid-cols-2 gap-3 sm:mt-16 sm:grid-cols-4 sm:gap-4">
            {capabilities.map((cap) => (
              <Link
                key={cap.title}
                href={cap.href}
                className="group flex flex-col items-center gap-3 rounded-xl border border-navy-800 bg-navy-800/30 p-4 text-center transition-all hover:border-accent-500/40 hover:bg-navy-800/60 sm:p-6"
              >
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-accent-600/10 transition-colors group-hover:bg-accent-600/20">
                  <svg
      ...
      <section className="border-y border-navy-800 bg-navy-950 py-12 sm:py-20">
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mt-3 text-2xl font-bold text-navy-100 sm:text-3xl">
            See It in Action
          </p>
          <p className="mt-4 text-navy-400">
            Book a 30-minute walkthrough tailored to your council. We will show you
            real compliance data, HMO detection in action, and how enforcement
      ...
      {/* ROI Calculator */}
      <section id="roi-calculator" className="py-14 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      {/* Pricing */}
      <section id="pricing" className="border-y border-navy-800 bg-navy-950 py-14 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-sm font-semibold uppercase tracking-wider text-accent-500">
              Pricing
